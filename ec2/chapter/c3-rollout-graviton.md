...
![](https://github.com/gnosia93/get-started-eks/blob/main/images/asg-instance-refresh.png)
* 새로운 론치(Launch) 템플릿 버전 생성하여 AMI를 Graviton 으로 바꾸고, 인스턴스 타입을 c7g.2xlarge 변경한다.
