## Graviton EC2 Migration ##

* [VPC 생성하기](https://github.com/gnosia93/get-started-eks/tree/main/cf)
...
* ALB가 사용하는 타겟 그룹 선택 → [Targets] 탭 → [Register targets] 클릭 → 새로 만든 ARM 인스턴스 선택.  
